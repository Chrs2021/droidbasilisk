...
int main(int argc, char **argv)
{
  //monstartup("libbasilisk.so");
	...
	// Read preferences
	ALOG_DEBUG ("BasMain: read preferences....");
	...
	ALOG_DEBUG ("BasMain: sysinit....");
	SysInit();
	ALOG_DEBUG ("BasMain: done.");
...
/*
  ...
  ALOG_DEBUG ("BasMain ram size:%d", RAMSize);
